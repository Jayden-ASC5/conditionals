...
if(item == "jacket"){money = money - 40; health = health +20; console.log("You bought a jacket")}
else if(item == "candy"){money = money - 10; console.log("You bought candy")}
else if(item == "paint"){money = money - 30; console.log("You bought paint")}
else if(item == "hammer"){money = money - 70; console.log("You bought a hammer")}
else{console.log("You bought nothing")};
